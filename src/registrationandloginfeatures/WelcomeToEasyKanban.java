...
public class WelcomeToEasyKanban {
    ...
    private void addTasks(List<Map<String, String>> tasks) {
        ...
        for (int i = 0; i < numTasks; i++) {
            ...
            //Increase task number for the next task.
            tasks.add(task);
            taskNumber++; 
        }
    }

    //Generates a task ID based on task name, task number, and developer's last name.
    ...
    void displayTasks(List<Map<String, String>> tasks) {
    ...
    //Deletes a task based on user input of task ID.
    ...
    private void searchTask(List<Map<String, String>> tasks) {
        //Search for a task based on user input of task ID.
    ...
    String generateTaskID(String taskName, Object taskNumber, String devLastName) {
